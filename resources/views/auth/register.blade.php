            ...
            <div class="content-form">
                ...
                <div class="col-md-6 col-sm-10 padding-leftright-null">
                    <div class="text padding-onlybottom-sm padding-md-top-null">
                        <form id="contact-form" class="padding-onlytop-md padding-md-topbottom-null" action="{{ route('register') }}">
                            @csrf
                            <h3 class="text-center">Dolomia</h3>
                            <p class="text-center">Complétez le formulaire pour créer un compte.</p>
                            @error('lastname')
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input class="form-field" name="username" id="username" type="text" placeholder="Nom d'utilisateur" required>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
